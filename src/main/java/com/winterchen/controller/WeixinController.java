...
import com.winterchen.util.wx.IpUtils;
import com.winterchen.util.wx.StringUtils;
import com.winterchen.util.wx.weixin.Json;
import com.winterchen.util.wx.weixin.PayUtil;
import com.winterchen.util.wx.weixin.config.WxPayConfig;
...
public class WeixinController extends WeixinSupport {
    ...
    public Json wxPay(String openid,String body,String orderID,String money1,int status, HttpServletRequest request){
        Json json = new Json();
        try{
            //生成的随机字符串
...
//            String orderNo = "23243";
            ...
            System.err.println("=======================第一次签名：" + mysign + "=====================");
            ...
            if(return_code == "SUCCESS" || return_code.equals(return_code)){
                ...
                System.err.println("=======================第二次签名：" + paySign + "=====================");
                ...
                //更改订单状态
                orderInfoDao.status(orderID,status);
            }
